package com.mk.newsshorts.core.model.deeplink
...
object ArticleDeepLinks {
    ...
    const val SHARE_REFERRER: String = ContractArticleDeepLinks.SHARE_REFERRER

    /** Last path segment of a shared link, and of the published landing page. */
    const val LANDING_PATH: String = ContractArticleDeepLinks.LANDING_PATH
    ...
    fun sharePageUrl(raw: String?, baseUrl: String): String? =
        ContractArticleDeepLinks.sharePageUrl(raw, baseUrl)
    ...
    fun shareUrl(article: NewsArticle, baseUrl: String, language: String): String {
        return ContractArticleDeepLinks.shareUrl(article.articleUrl.value, baseUrl, language)
    }
}

 ...
 * without one.
 */
internal fun readAppPreferences(getString: (key: String, fallback: String) -> String): AppPreferences {
...
internal const val KEY_NEWS_LANGUAGE: String = "news_language"
internal const val KEY_APP_LOCALE: String = "app_locale"
internal const val KEY_SELECTED_COUNTRY: String = "selected_country"
internal const val KEY_THEME_MODE: String = "theme_mode"
internal const val KEY_TEXT_SCALE: String = "text_scale"

internal const val DEFAULT_NEWS_LANGUAGE: String = "en"
internal const val DEFAULT_APP_LOCALE: String = "en"
internal const val DEFAULT_COUNTRY: String = "us"
internal const val DEFAULT_THEME_MODE: String = "system"
internal const val DEFAULT_TEXT_SCALE: String = "default"
